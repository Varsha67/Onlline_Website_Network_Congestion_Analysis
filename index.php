  ...
  <div class="container">
    <div class="placeholder">
      ...
      <aside class = "menu">
          ...
          <!-- <a href="login.php">Login</a>|<a href="SiginUP.php">Register</a> -->
          ...
          <div class="row tm-header-inner">
            <div class="col-md-6 col-12">
              ...
              <div class="tm-site-text-box">
                ...
                <h6 class="tm-site-description">Based on  Big Data Technologies</h6>  
              </div>
            </div>
            <nav class="col-md-6 col-12 tm-nav">
              <ul class="tm-nav-ul">
    ...
    <main>
      <header class="row tm-welcome-section" style="margin-left: 250px; ">
  ...
  <figure>
            ...
            <aside>
              ...
              margin-top: 100px; height: 200px; width: 350px "/>
                ...
                <br>
                <p class="tm-gallery-description " style="margin-left: 450px;
                margin-right: 100px; 
...
Anomaly detection is the process of finding outliers in the data set.Outliers are the data objects that stand out amongst other objects in the data set and do not conform to the normal behavior in a data set.</p> 
                       ...
                       <br>
                        <br>
                        <form action="linegraph.php" style="margin-top: 50px;">
...
<div id="Contact" class="tabcontent" style="margin-left: 400px; ">
  <form name="calculator">
         <table>
            <tr>
               <td colspan="4">
                  <input type="text" name="display" id="display" disabled placeholder="Enter:" >
               </td>
            </tr>
            <tr>
